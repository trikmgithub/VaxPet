...
class _AppointmentMicrochipNoteState extends State<AppointmentMicrochipNote>
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return MicrochipAppointmentCard(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return AnimatedContainer(
                    ...
                    child: MicrochipAppointmentCard(
                      appointment: appointment,
                      isPending: false,
                    ),
                  );
  ...
  void _showFilterDialog(
    ...
    // Map appointment statuses to readable text for microchip
    final statusMap = {
      2: {
        'name': 'Đã xác nhận',
        'color': Colors.green,
...
class MicrochipAppointmentCard extends StatelessWidget {
  final dynamic appointment;
  final bool isPending;

  const MicrochipAppointmentCard({
    super.key,
    required this.appointment,
    required this.isPending,
  });

  // Helper method to get status info for microchip
  ...
  String _getServiceTypeText(int serviceType) {
    // Implement your service type text mapping logic here for microchip
    return serviceType == 2 ? 'Cấy chip' : 'Dịch vụ khác';
  }
