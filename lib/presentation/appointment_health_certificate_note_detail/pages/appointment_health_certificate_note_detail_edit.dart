...
import '../bloc/appointment_health_certificate_note_detail_edit_state.dart';
import '../../../common/widgets/back_button/back_button.dart';

class AppointmentHealthCertificateNoteDetailEditPage extends StatefulWidget {
  final Map<String, dynamic> appointmentData;

  const AppointmentHealthCertificateNoteDetailEditPage({
    super.key,
    required this.appointmentData,
  });

  @override
  State<AppointmentHealthCertificateNoteDetailEditPage> createState() =>
      _AppointmentHealthCertificateNoteDetailEditPageState();
}

class _AppointmentHealthCertificateNoteDetailEditPageState
    extends State<AppointmentHealthCertificateNoteDetailEditPage> {
  ...
  void _initializeForm() {
    // Access appointment data directly (health certificate structure)
  ...
  Widget _buildLocationField(AppointmentHealthCertificateNoteDetailEditState state) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.grey[50],
        borderRadius: BorderRadius.circular(8),
  ...
  // Stylized address field exactly like in microchip
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        if (_addressController.text.trim().isEmpty) {
                          _showSnackBar('Vui lòng nhập địa chỉ', isError: true, icon: Icons.warning);
                          return;
                        }
  ...
  // Submit button with custom implementation
  Widget _buildUpdateButton(AppointmentHealthCertificateNoteDetailEditState state) {
    return SizedBox(
      width: double.infinity,
      height: 50,
      child: ElevatedButton(
        onPressed:
            state.status == AppointmentHealthCertificateNoteDetailEditStatus.loading
                ? null
                : () async {
                  try {
                    ...
                    _showSnackBar(e.toString(), isError: true, icon: Icons.error);
                  }
                },
        style: ElevatedButton.styleFrom(
          backgroundColor: Theme.of(context).primaryColor,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'Vui lòng đến đúng giờ hẹn và mang theo giấy tờ cần thiết để thực hiện dịch vụ cấp giấy chứng nhận sức khỏe cho thú cưng!',
  ...
  // Overlay notification like microchip
  void _showSnackBar(
    String message, {
    bool isError = false,
    IconData? icon,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          'Chỉnh sửa lịch hẹn giấy chứng nhận sức khỏe',
                          style: TextStyle(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: BlocConsumer<
                      ...
                      AppointmentHealthCertificateNoteDetailEditState
                    >(
                      listener: (context, state) {
                        if (state.status ==
                            AppointmentHealthCertificateNoteDetailEditStatus.success) {
                          _showSnackBar(
                          ...
                          Navigator.of(context).pop(true);
                            ...
                            AppointmentHealthCertificateNoteDetailEditStatus.failure) {
                          _showSnackBar(
                        ...
                        return Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildFormLabel('Ngày hẹn cấp giấy chứng nhận:'),
                              ...
                              // Show address field when location = 2 (Home)
                              if (state.location == 2) ...[
                                const SizedBox(height: 20),
