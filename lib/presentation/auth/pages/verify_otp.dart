...
class _VerifyOtpPageState extends State<VerifyOtpPage> with TickerProviderStateMixin {
  ...
  Widget _buildTimer() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: _remainingSeconds <= 30 ? Colors.red.withOpacity(0.1) : Colors.orange.withOpacity(0.1),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: _remainingSeconds <= 30 ? Colors.red.withOpacity(0.3) : Colors.orange.withOpacity(0.3),
        ),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
