...
class AppointmentHealthCertificateClinicPage extends StatefulWidget {
  final int serviceType = 3; // 3 cho giấy chứng nhận sức khỏe
  final int location = 1; // 1 cho dịch vụ trung tâm
  final String petName;
  final int petId;
  final String petSpecies;
  const AppointmentHealthCertificateClinicPage({
    super.key,
  ...
  @override
  State<AppointmentHealthCertificateClinicPage> createState() =>
      _AppointmentHealthCertificateClinicPageState();
}

class _AppointmentHealthCertificateClinicPageState
    extends State<AppointmentHealthCertificateClinicPage> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        'Đặt lịch cấp giấy chứng nhận sức khỏe tại trung tâm',
                        style: TextStyle(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        'Giấy chứng nhận sức khỏe sẽ được cấp sau khi thú cưng được khám và đánh giá tình trạng sức khỏe!',
        ...
        onTap: () async {
          ...
          final ThemeData theme = Theme.of(context).copyWith(
            timePickerTheme: TimePickerThemeData(
              ...
              dayPeriodTextColor: Colors.green.shade700,
      ...
      child: ReactiveButton(
        onPressed: () async {
          ...
          try {
            ...
            final result = await sl<PostAppointmentHealthCertificateUseCase>().call(
              params: PostAppointmentHealthCertificateModel(
        ...
        onFailure: (error) {
          debugPrint('Error creating health certificate appointment: $error');
