...
class SampleSchedulePetPage extends StatelessWidget {
  ...
  String _calculatePetAge() {
    ...
    try {
      ...
      if (petBirthday!.contains('-')) {
        final parts = petBirthday!.split('-');
        if (parts.length == 3) {
          ...
          if (part1 != null && part2 != null && part3 != null) {
            ...
            if (part1 > 31 || (part1 > 12 && part3 <= 31)) {
              // Format: yyyy-mm-dd (first part > 31 or first part > 12 and last part <= 31)
              final year = part1;
              final month = part2;
              final day = part3;
              ...
              // Format: dd-mm-yyyy (last part > 31 or last part > 12 and first part <= 31)
              final day = part1;
              final month = part2;
              final year = part3;
              ...
              // Ambiguous format, try dd-mm-yyyy first (more common in Vietnam)
              final day = part1;
              final month = part2;
              final year = part3;
        ...
        if (parts.length == 3) {
          ...
          if (part1 != null && part2 != null && part3 != null) {
            ...
            if (part1 > 31 || (part1 > 12 && part3 <= 31)) {
              ...
              // Ambiguous format, try dd-mm-yyyy first
              final day = part1;
              final month = part2;
              final year = part3;
