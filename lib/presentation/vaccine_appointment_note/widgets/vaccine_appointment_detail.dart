...
class VaccineAppointmentDetail extends StatelessWidget {
  const VaccineAppointmentDetail({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<VaccineAppointmentNoteDetailCubit, VaccineAppointmentNoteDetailState>(
      builder: (context, state) {
        if (state.status == VaccineAppointmentNoteDetailStatus.loading) {
          return const Center(child: CircularProgressIndicator());
        } else if (state.status == VaccineAppointmentNoteDetailStatus.failure) {
          return Center(child: Text('Lỗi: ${state.errorMessage}'));
        } else if (state.status == VaccineAppointmentNoteDetailStatus.success && state.appointmentDetail != null) {
  ...
  Widget _buildAppointmentDetail(BuildContext context, dynamic appointment) {
    ...
    // Get customer email from the nested structure
